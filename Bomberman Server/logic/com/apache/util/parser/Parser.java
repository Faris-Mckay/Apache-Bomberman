 ...
 *
 * @param <T1>
 *            The reader that will be parsing the file.
 * @param <T2>
 *            The {@code Object} being parsed.
...
public abstract class Parser<T1, T2> implements Runnable {
	 ...
	 *
	 * @param reader
	 *            The reader to parse the file with.
	 ...
	 *
	 * @param in
	 *            The {@link BufferedReader} used to get the reader of the file.
	 * @return The reader of the file.
	 * @throws Exception
	 *             If any errors occur while getting the reader.
	 */
	 ...
	 *
	 * @param objectReader
	 *            The reader for the {@code Object}s being parsed.
	 * @return {@code true} if more data can be read, {@code false} otherwise.
	 * @throws Exception
	 *             If any errors occur while determining the read status.
	 */
	 ...
	 *
	 * @param readObjects
	 *            The list of {@code Object}s that were parsed, possibly at a
	 *            size of {@code 0}.
	 * @throws Exception
	 *             If any errors occur while executing completion logic.
	 */

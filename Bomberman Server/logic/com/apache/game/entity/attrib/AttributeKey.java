...
/**
 * A {@link String} wrapper also known as an alias that defines behavior and
 * functionality for attributes. {@code String} keys are forcibly interned and
 * aliased on startup into an {@link IdentityHashMap} to be easily accessible as
 * well as high performing.
 * <p>
 * The naming convention for all {@code String} keys is
 * {@code lower_underscore}. Spaces and uppercase letters are not allowed.
 *
 * @param <T>
 *            The {@link Object} type represented by this key.
 * @author Juan Ortiz <http://github.org/TheRealJP>
 */
public final class AttributeKey<T> {

	/**
	 * An {@link IdentityHashMap} of {@link String} keys mapped to their
	 * {@code AttributeKey} aliases. All {@code String}s added to this map are
	 * forcibly interned so we can compare them by their identity for faster
	 * performance.
	 */
	...
	/**
	 * Aliases {@code name} with an initial value of {@code initialValue} that
	 * will be written to and read from the character file.
	 *
	 * @param name
	...
	/**
	 * @return {@code true} if the value of this alias should be serialized,

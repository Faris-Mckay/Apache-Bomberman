...
public final class MessageRepository {
	 ...
	 *
	 * @param opcode
	 *            The opcode of the message handler.
	 * @param size
	 *            The size of the message.
	 * @param inboundMessageName
	 *            The class name of the {@link InboundGameMessage}, implicitly
	 *            prefixed with the {@code
	 * com.apache.net.msg.in} package.
	 * @throws ReflectiveOperationException
	 *             If any errors occur while instantiating the
	 *             {@link InboundGameMessage}.
	 */
	 ...
	 *
	 * @param opcode
	 *            The opcode to retrieve the size of.
	 ...
	 *
	 * @param opcode
	 *            The opcode to retrieve the message handler for.

...
public final class ByteMessage extends DefaultByteBufHolder {
    ...
    /**
     * F static initialization block that calculates the bit masks.
     */
    static {
    ...
    public ByteMessage put(int value) {
        put(value, ByteTransform.DEFAULT);
        return this;
    }
    ...
    public ByteMessage putShort(int value) {
        putShort(value, ByteTransform.DEFAULT, ByteOrder.BIG);
        return this;
    }
    ...
    public ByteMessage putShort(int value, ByteOrder order) {
        putShort(value, ByteTransform.DEFAULT, order);
        return this;
    }
    ...
    public ByteMessage putInt(int value) {
        putInt(value, ByteTransform.DEFAULT, ByteOrder.BIG);
        return this;
    }
    ...
    public ByteMessage putInt(int value, ByteOrder order) {
        putInt(value, ByteTransform.DEFAULT, order);
        return this;
    }
    ...
    public ByteMessage putLong(long value) {
        putLong(value, ByteTransform.DEFAULT, ByteOrder.BIG);
        return this;
    }
    ...
    public ByteMessage putLong(long value, ByteOrder order) {
        putLong(value, ByteTransform.DEFAULT, order);
        return this;
    }
     ...
     */
    public int get() {
        return get(true, ByteTransform.DEFAULT);
    }
    ...
    public int get(boolean signed) {
        return get(signed, ByteTransform.DEFAULT);
    }
     ...
     */
    public int getShort() {
        return getShort(true, ByteTransform.DEFAULT, ByteOrder.BIG);
    }
    ...
    public int getShort(boolean signed) {
        return getShort(signed, ByteTransform.DEFAULT, ByteOrder.BIG);
    }
    ...
    public int getShort(ByteOrder order) {
        return getShort(true, ByteTransform.DEFAULT, order);
    }
    ...
    public int getShort(boolean signed, ByteOrder order) {
        return getShort(signed, ByteTransform.DEFAULT, order);
    }
     ...
     */
    public int getInt() {
        return getInt(true, ByteTransform.DEFAULT, ByteOrder.BIG);
    }
    ...
    public int getInt(boolean signed) {
        return getInt(signed, ByteTransform.DEFAULT, ByteOrder.BIG);
    }
    ...
    public int getInt(ByteOrder order) {
        return getInt(true, ByteTransform.DEFAULT, order);
    }
    ...
    public int getInt(boolean signed, ByteOrder order) {
        return getInt(signed, ByteTransform.DEFAULT, order);
    }
     ...
     */
    public long getLong() {
        return getLong(ByteTransform.DEFAULT, ByteOrder.BIG);
    }
    ...
    public long getLong(ByteOrder order) {
        return getLong(ByteTransform.DEFAULT, order);
    }
    ...
    public byte[] getBytes(int amount) {
        return getBytes(amount, ByteTransform.DEFAULT);
    }
